 ...
 */
function inlineHtmlImport(analyzer, document, linkTag, stripImports, docBundle, manifest, enableSourcemaps, skipUnresolvedImports, rewriteUrlsInTemplates, excludes) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (document.url === resolvedImportUrl || skipUnresolvedImports) {
            astUtils.removeElementAndNewline(linkTag);
            return;
        }
        ...
        for (const nestedImport of nestedImports) {
            yield inlineHtmlImport(analyzer, document, nestedImport, stripImports, docBundle, manifest, enableSourcemaps, skipUnresolvedImports, rewriteUrlsInTemplates, excludes);
        }
    });
}
